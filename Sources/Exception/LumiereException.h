...
#define LUMIERE_THROW_EXCEPTION(exceptionCode, description)  NAMESPACE_NAME::ExceptionFactory::throwException(exceptionCode, description, __EXCEPTION_SITE__)
#define LUMIERE_THROW_EXCEPTION_FMT(exceptionCode, fmtStr, ...)  NAMESPACE_NAME::ExceptionFactory::throwException(exceptionCode, fmt::format(fmtStr, __VA_ARGS__), __EXCEPTION_SITE__)